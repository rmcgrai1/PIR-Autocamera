...
float calcWeightedSum(float weight1, float val1, float weight2, float val2, float weight3, float val3) {
...
float maxa(float array[], int size) {return maxt(array, size, false);}
long maxa(long array[], int size)   {return maxt(array, size, false);}

// Get Min Value in Array
float mina(float array[], int size) {return mint(array, size, false);}
long mina(long array[], int size)   {return mint(array, size, false);}


// Get Index of Max Value in Array
int maxi(float array[], int size)   {return maxt(array, size, true);}
int maxi(long array[], int size)    {return maxt(array, size, true);}

// Get Index of Min Value in Array
int mini(float array[], int size)   {return mint(array, size, true);}
int mini(long array[], int size)    {return mint(array, size, true);}
...
void convertFraction2Bytes(float frac, int minNum, int maxNum, byte array[], int index) {
  int num = (int) (minNum + frac*(maxNum - minNum)),
      units = num % 16,
      tens = (num - units) / 16;
...
float calcLenX(float r, float deg) {return r*cos(deg/180*PI);}
float calcLenY(float r, float deg) {return r*sin(deg/180*PI);}
